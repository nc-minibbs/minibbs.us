...
var $author$project$Main$ByTrait = function (a) {
	return {$: 'ByTrait', a: a};
};
var $author$project$Data$Traits$WinterBiome = {$: 'WinterBiome'};
var $author$project$Displays$ByTrait$init = {selectedTrait: $author$project$Data$Traits$WinterBiome};
var $author$project$Main$init = $author$project$Main$ByTrait($author$project$Displays$ByTrait$init);
...
var $author$project$Main$GotByTraitMsg = function (a) {
	return {$: 'GotByTraitMsg', a: a};
};
...
var $author$project$Displays$ByTrait$trendByTraitSpec = A2($author$project$Specs$TrendByTrait$mkTrendByTraitSpec, $author$project$Data$Mbbs$mbbsData, $author$project$Data$Traits$traitsData);
var $author$project$Displays$ByTrait$specs = function (trait) {
	return $gicentre$elm_vegalite$VegaLite$combineSpecs(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'trendByTrait',
				$author$project$Displays$ByTrait$trendByTraitSpec(trait))
			]));
};
var $author$project$Displays$ByTrait$vegaLite = _Platform_outgoingPort('vegaLite', $elm$core$Basics$identity);
var $author$project$Displays$ByTrait$update = F2(
	function (msg, model) {
		var opt = msg.a;
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{selectedTrait: opt}),
			$author$project$Displays$ByTrait$vegaLite(
				$author$project$Displays$ByTrait$specs(opt)));
	});
...
var $author$project$Main$update = F2(
	function (msg, model) {
		...
		return A3(
			...
			$author$project$Main$ByTrait,
			$author$project$Main$GotByTraitMsg,
			A2($author$project$Displays$ByTrait$update, submsg, submodel));
	});
...
var $author$project$Displays$ByTrait$SelectTrait = function (a) {
...
var $author$project$Displays$ByTrait$traitRadio = function (model) {
	return A2(
			...
			_List_fromArray(
				[
					...
					_List_Nil,
					{
						...
						onChange: $author$project$Displays$ByTrait$SelectTrait,
...
var $author$project$Displays$ByTrait$view = function (m) {
	return A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Displays$ByTrait$traitRadio(m))
					])),
				A2(
				$rtfeldman$elm_css$Html$Styled$div,
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$id('trendByTrait')
					]),
				_List_Nil)
			]));
};
var $author$project$Main$view = function (m) {
	...
	return A2(
		...
		$author$project$Main$GotByTraitMsg,
		$author$project$Displays$ByTrait$view(submodel));
};
