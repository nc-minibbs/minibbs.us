...
var $author$project$Main$counts = A2(
...
var $author$project$Main$trendChart = function (data) {
	var trans3 = A2(
...
var $author$project$Main$mainTrends = $author$project$Main$trendChart($author$project$Main$counts);
var $author$project$Main$mbbsSpecs = $gicentre$elm_vegalite$VegaLite$combineSpecs(
	_List_fromArray(
		[
			_Utils_Tuple2('mainTrends', $author$project$Main$mainTrends)
		]));
...
var $author$project$Main$main = $elm$core$Platform$worker(
	{
		init: $elm$core$Basics$always(
			_Utils_Tuple2(
				$author$project$Main$mbbsSpecs,
				$author$project$Main$elmToJS($author$project$Main$mbbsSpecs))),
