...
var $author$project$Species$AmericanCrow = {$: 'AmericanCrow'};
var $author$project$Species$CarolinaWren = {$: 'CarolinaWren'};
var $author$project$Species$NorthernCardinal = {$: 'NorthernCardinal'};
var $author$project$Species$allSpecies = _List_fromArray(
	[$author$project$Species$NorthernCardinal, $author$project$Species$AmericanCrow, $author$project$Species$CarolinaWren]);
...
var $author$project$Species$speciesToString = function (species) {
	switch (species.$) {
...
var $author$project$Species$speciesToMenuItem = function (species) {
	return $Confidenceman02$elm_select$Select$basicMenuItem(
		{
			item: species,
			label: $author$project$Species$speciesToString(species)
		});
};
var $author$project$Species$speciesMenuItems = A2($elm$core$List$map, $author$project$Species$speciesToMenuItem, $author$project$Species$allSpecies);
var $author$project$Species$init = {
	items: $author$project$Species$speciesMenuItems,
...
var $author$project$Species$SelectMsg = function (a) {
...
var $author$project$SpeciesTrend$counts = A2(
...
var $author$project$SpeciesTrend$speciesChart = F2(
	function (x, species) {
		var trans = A2(
			...
			$gicentre$elm_vegalite$VegaLite$filter(
				A2(
					...
					'common_name',
					$gicentre$elm_vegalite$VegaLite$str(species))));
		var ps = A2(
			$elm$core$Basics$composeL,
...
var $author$project$SpeciesTrend$mbbsSpecs = function (x) {
	return $gicentre$elm_vegalite$VegaLite$combineSpecs(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'speciesTrend',
				$author$project$SpeciesTrend$speciesTrend(x))
			]));
};
...
var $author$project$Species$vegaLiteSpec = _Platform_outgoingPort('vegaLiteSpec', $elm$core$Basics$identity);
var $author$project$Species$update = F2(
	function (msg, model) {
		var sm = msg.a;
		...
		var specMsg = function () {
			if ((maybeAction.$ === 'Just') && (maybeAction.a.$ === 'Select')) {
				...
				return $author$project$Species$vegaLiteSpec(
					$author$project$SpeciesTrend$mbbsSpecs(
						$author$project$Species$speciesToString(i)));
			} else {
				return $elm$core$Platform$Cmd$none;
			}
		}();
		var updatedSelectedItem = function () {
			_v2$2:
			while (true) {
				if (maybeAction.$ === 'Just') {
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{selectState: selectState, selectedSpecies: updatedSelectedItem}),
			A2($elm$core$Platform$Cmd$map, $author$project$Species$SelectMsg, specMsg));
	});
...
var $author$project$Species$view = function (m) {
	var selectedItem = function () {
		var _v0 = m.selectedSpecies;
		if (_v0.$ === 'Just') {
			var i = _v0.a;
			return $elm$core$Maybe$Just(
				$author$project$Species$speciesToMenuItem(i));
		} else {
			return $elm$core$Maybe$Nothing;
		}
	}();
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Species$SelectMsg,
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text(
						$elm$core$Debug$toString(m.selectedSpecies))
					])),
				A2(
				$rtfeldman$elm_css$Html$Styled$div,
				_List_fromArray(
...
var $author$project$Species$main = $elm$browser$Browser$element(
	{
		init: $elm$core$Basics$always(
			_Utils_Tuple2($author$project$Species$init, $elm$core$Platform$Cmd$none)),
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$Species$update,
		view: A2($elm$core$Basics$composeR, $author$project$Species$view, $rtfeldman$elm_css$Html$Styled$toUnstyled)
	});
_Platform_export({'Species':{'init':$author$project$Species$main(
